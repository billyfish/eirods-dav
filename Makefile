...
CFILES := mod_davrods.c auth.c common.c config.c prop.c propdb.c repo.c meta.c theme.c rest.c
HFILES := mod_davrods.h auth.h common.h config.h prop.h propdb.h repo.h meta.h theme.h rest.h
